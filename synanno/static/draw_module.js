$(document).ready(function () {
    ...
    $('[id^="drawButton-"]').click(async function () {
        ...
        req_data = $.ajax({
            url: '/get_instance',
            type: 'POST',
            data: { mode: mode, load: load, data_id: data_id, page: page, base_mask_path: base_mask_path}
        });
    ...
    $('#rangeSlices').on('input', function () {
        ...
        req = $.ajax({
            url: '/get_instance',
            type: 'POST',
            data: { mode: mode, load:load, data_id: data_id, page: page, base_mask_path: base_mask_path, viewed_instance_slice: viewed_instance_slice}
        });
